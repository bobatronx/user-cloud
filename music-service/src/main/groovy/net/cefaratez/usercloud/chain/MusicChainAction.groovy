package net.cefaratez.usercloud.chain

import groovy.json.JsonSlurper
import net.cefaratez.usercloud.command.GetArtistByIdCommand
import net.cefaratez.usercloud.command.GetArtistByNameCommand
import net.cefaratez.usercloud.command.GetArtistsCommand
import net.cefaratez.usercloud.command.SaveArtistCommand
